...
| `artifacts/supporting/` | **Supporting governance views** — not core artifacts (the Technology Radar precedent, Book 1 §21.6). Currently the **Regulatory Obligations Register** (GDPR / EU AI Act / ePrivacy / sector obligation mapping). |
